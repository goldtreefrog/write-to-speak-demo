...
const storeAuthInfo = (authToken, dispatch) => {
  ...
  dispatch(authSuccess(decodedToken.user)); // load user from authToken into state
  saveAuthToken(authToken); // Saves in localStorage

  // Add snippets from user record to state. Redundant but will allow undo later.
